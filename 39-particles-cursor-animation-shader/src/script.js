 ...
 * Particles
 */
const particlesGeometry = new THREE.PlaneGeometry(17, 10, 512, 512)
...
for (let i = 0; i < particlesGeometry.attributes.position.count; i++) {
    ...
    angleArray[i] = Math.random() * Math.PI  
}
...
const particlesMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        ...
        uPictureTexture: new THREE.Uniform(trooper),
