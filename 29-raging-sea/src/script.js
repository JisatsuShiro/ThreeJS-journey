...
gui.add(waterMaterial.uniforms.uBigWavesFrequency.value, 'y').min(0).max(10).step(0.001).name('wavesFrequencyX')
...
gui.addColor(debugObject, 'surfaceColor').name('depthColor').onChange(() => {
